...
class _PageInstructionState extends State<PageInstruction> {
  ...
  void initState() {
    super.initState();
    _form = InstructionForm(widget.routeData, widget.routeData.configuration, widget.routeData.service);
  }
  ...
  void _showForm(Configuration configuration, List<Account> accounts, ValueGeneratorBank bankValueGenerator,
      List<Widget> children) {
    ...
    if (_form.toBank.value.value != null) {
      widget.routeData.flowCustomisation.interbankAddBranchSelectionWidget(children, _form, _sizeBoxHeight);
    }
  ...
  void _continue(BuildContext context) {
    ...
    if (_form.form.validate()) {
      ...
      widget.routeData.data = InterBankFlowData(
          ...
          (_form.toBranch != null) ? _form.toBranch!.getValueAs<ListItemNameValue>() : null,
